...
class VocabularyCard(id: String, course: String, repeatLevel: Int, practiceLevel: Int,
    ...
    @Ignore var trains :ArrayList<Sentence.Train>? = null
    @Ignore var examples :ArrayList<Sentence.Example>? = null
